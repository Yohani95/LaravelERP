                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('companies.destroy',$company->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary mb-2" href="{{ route('companies.show',$company->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success mb-2" href="{{ route('companies.edit',$company->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm mb-2"><i class="fa fa-fw fa-trash"></i> Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
