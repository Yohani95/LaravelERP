                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a type="button" id="addRow"
                                                        onclick="addProductButton({{ $product }})"
                                                        class="badge bg-success "><i class="fa-solid fa-cart-plus"></i></i>
                                                        Añadir </a>
                                                    {{-- </form> --}}
                                                </td>
                                            </tr>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formulario" action="" method="POST">
                            @csrf
                            <ul class="list-group">
                                <li class="list-group-item"><i class="bi bi-cash me-1 text-primary"></i>Monto Neto : <input
                                        type="text" id="montoNeto" name="montoNeto" class="form-control" value="0"
                                        disabled style="border: 0"></li>
                                <li class="list-group-item"><i class="bi bi-collection me-1 text-primary"></i>Iva : <br>
                                    <input type="text" id="iva" name="iva" class="form-control"value="0"
                                        disabled style="border: 0"></li>
                                <li class="list-group-item"><i class="bi bi-check-circle me-1 text-success"></i>Total : <br>
                                    <input type="text" id="totalMonto" name="totalMonto" class="form-control"
                                        value="0" disabled style="border: 0"></li>
                                <li class="list-group-item"><i class="bi bi-piggy-bank me-1 text-warning"></i>Descuentos :
                                    <input type="text" class="form-control" value="0" disabled style="border: 0">
                                </li>
                            </ul>
                            ...
                            <div class="d-grid gap-2 mt-3"> <button id="buttonPay" class="btn btn-primary"
                                    onclick="payProducts()">
...
@section('js')
    ...
    <script>
        ...
        async function payProducts() {
            ...
            btncompra.innerHTML =
                '<span id="spinner" class="spinner-border spinner-border-sm" role="status" aria-hidden="true" ></span> Realizando Pago ...';
